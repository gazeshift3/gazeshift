...
class VRGazeSinglePersonDataset(Dataset):
    def __init__(self, args, data_dir_root, labels=None, stage=None):
        ...
        #self.normalize = torchvision.transforms.Normalize(0.5, 0.5)
        self.random_crop = torchvision.transforms.RandomCrop((400, 400), 50, True, padding_mode='edge')
