...
Link to the paper: https://arxiv.org/pdf/2603.07832
...
1. Download checkpoint (1.84 [deg] accuracy on VRGaze) from https://drive.google.com/file/d/1U-txJpQUm7YTXd13n2lYXAQ8zkz3iieC/view?usp=drive_link
2. Edit val.sh with your local paths
3. source val.sh - you should see the 1.84 [deg] accuracy result.
